            ...
            switch (c) {
                ...
                case '0':
                    ...
                    if (sUtil.getToken("0")) {
                        ...
                        if (type == MACHINEDRIVER) {
                            if ((i3 == 0) && ((insideagk[i3] == 3) || (insideagk[i3] == 5) || (insideagk[i3] == 6) || (insideagk[i3] == 12) || (insideagk[i3] == 14) || (insideagk[i3] == 15))) {
                                sUtil.putString("null");
                                Convertor.inpos += 1;
                                continue;
                            } else if ((i3 == 0) /*&& (type3==1)*/ && ((insideagk[i3] == 4) || (insideagk[i3] == 8) || (insideagk[i3] == 11) || (insideagk[i3] == 13) || (insideagk[i3] == 14) || (insideagk[i3] == 15) || (insideagk[i3] == 16))) {
